...
import { ChevronRight, ChevronLeft, Settings, ClipboardList, Clock, ReceiptPoundSterling } from "lucide-react";
...
export default function SideBar() {
    ...
    const { currTitle, setContent, setIsVisible, isVisible, setDirection, setTitle } = useModal();
