...
export default function Shortcut({name,iconPath,url}:Props){
    ...
    return(
        <div className="group relative flex flex-col items-center justify-center cursor-pointer w-auto duration-500 hover:backdrop-blur-sm hover:shadow-lg hover:bg-[var(--tint)] p-4 rounded-xl" >
